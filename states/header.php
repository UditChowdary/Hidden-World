        ...
        <header class="tech-header header">
            <div class="container-fluid">
                <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                    ...
                    <a class="navbar-brand" href="index.php"><img  src="uploads/<?= $siteData['logo']?>" alt="" style="width: 50px;" ></a>
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item" >
                                <a class="nav-link" href="poster.php" >Post the place </a>
                            </li>
                            <?php
            ...
            while ($row = mysqli_fetch_assoc($post)){
                        ...
                        <a href="singlepage.php?id=53" style="color: rgb(255, 255, 255);">Hidden Places</a>
